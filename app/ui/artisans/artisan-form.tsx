...
import { registerArtisan, updateArtisan } from '@/app/lib/action';
import { redirect, useSearchParams } from 'next/navigation';
import { Artisan, ArtisanFormState } from '@/app/lib/definitions';
import { toast } from 'sonner';
import { DeleteArtisanBanner, DeleteArtisanPhoto } from './buttons';
...
export function UpdateArtisanForm(artisan: { data: Artisan }) {
    const searchParams = useSearchParams();
    const callbackUrl = searchParams.get('callbackUrl') || '/';
        ...
        <>
            ...
            <form action={formAction}>
                <div>
                    <div>
                        ...
                        <section>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    type="text"
                                    placeholder="Enter your artisan name/title"
                                    defaultValue={artisanData.display_name}
                                    required
                                />
                                <UserIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500" />
                            </div>
                        ...
                        <section>
                            ...
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder='Provide a detailed description of what you do'
                                    required
                                    defaultValue={artisanData.about}
                                ></textarea>
                                {allFieldErrors.about && (
                                    <p className="text-sm text-red-500 mt-1">{allFieldErrors.about}</p>
                                )}
                            ...
                            <div className="flex gap-4">
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        value="m"
                                        required
                                        defaultChecked={artisanData.gender == 'm' ? true : false}
                                    />
                                    <label htmlFor="male-gender">Male</label>
                                </div>
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        value="f"
                                        required
                                        defaultChecked={artisanData.gender == 'f' ? true : false}
                                    />
                                    <label htmlFor="female-gender">Female</label>
                                </div>
                            </div>
                        ...
                        <section>
                            ...
                            {artisanData.profile_photo && (
                                <DeleteArtisanPhoto id={artisanData.id} photo_url={artisanData.profile_photo} />
                            )}
                            {allFileErrors.profile_photo && (
                                <p className="text-sm text-red-500 mt-1">{allFileErrors.profile_photo}</p>
                            )}
                        ...
                        <section>
                            ...
                            {artisanData.banner && (
                                <DeleteArtisanBanner id={artisanData.id} photo_url={artisanData.banner} />
                            )}
                            {allFileErrors.profile_banner && (
                                <p className="text-sm text-red-500 mt-1">{allFileErrors.profile_banner}</p>
                            )}
                    ...
                    <input type="hidden" name="redirectTo" value={callbackUrl} />
                    <input type="hidden" name="id" value={artisanData.id} />
